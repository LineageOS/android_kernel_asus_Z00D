...
/*Garbage backdoor*/
extern int 		proximity_sysfs_read_garbageA(void);
extern int 		proximity_sysfs_read_garbageB(void);
extern bool 	proximity_sysfs_write_garbageA(int GA);
extern bool 	proximity_sysfs_write_garbageB(int GB);
...
#define PSENSOR_GA_FILE	"/asusfw/psensor_ga.nv"
#define PSENSOR_GB_FILE	"/asusfw/psensor_gb.nv"
