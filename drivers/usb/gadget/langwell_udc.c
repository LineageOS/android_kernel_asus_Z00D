...
/* ASUS_BSP+++ Landice "[ZE500CL][USBH][NA][Spec] support USB 1.0/2.0 switch" */
...
extern bool asus_otg_is_host_mode(void);
/* ASUS_BSP--- LandiceFu "[ZE500CL][USBH][NA][fix] Skip show_langwell_udc in host mode" */
...
/* ASUS_BSP+++ LandiceFu "[ZE500CL][USBH][NA][fix] Skip show_langwell_udc in host mode" */
	if (asus_otg_is_host_mode()) {
		printk("[usb_otg] skip show_langwell_udc in host mode\n");
		return 0;
	}
/* ASUS_BSP--- LandiceFu "[ZE500CL][USBH][NA][fix] Skip show_langwell_udc in host mode" */
...
extern void asus_otg_reset_notify(void);
/* ASUS_BSP--- LandiceFu "[ZE500CL][USBH][NA][Spec] Add asus_otg_set_charger function for charger control and support UNKNOWN charger" */
...
/* ASUS_BSP+++ Landice "[ZE500CL][USBH][NA][Spec] support USB 1.0/2.0 switch" */
	...
	if (switch_speed == 1) {
		switch_speed = 2;
		printk("[usb_otg] reset from USB 1.0 to USB 2.0\n");
	}
#endif
/* ASUS_BSP--- Landice "[ZE500CL][USBH][NA][Spec] support USB 1.0/2.0 switch" */
