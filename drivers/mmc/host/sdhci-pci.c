...
#include <asm/spid.h>
#include <linux/regulator/consumer.h>	/*ASUS_BSP Deeo : Intel SD workaround patch */

#include "sdhci.h"

#define REQ_COUNT_FMID 200		/*ASUS_BSP Deeo : Intel SD workaround patch */
	...
	int slotno)
{
	...
	host->mmc->caps2 |= MMC_CAP2_NO_PRESCAN_POWERUP | MMC_CAP2_BROKEN_MAX_CLK;
