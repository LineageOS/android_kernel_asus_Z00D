...
#define EDLP_ASUS_DEBUG_REPORT       1 /*ASUS-BBSP Trigger modem core dump when AP side received invalid PDU signature & size on TTY RX+*/
#else
...
#define EDLP_ASUS_DEBUG_REPORT       0 /*ASUS-BBSP Trigger modem core dump when AP side received invalid PDU signature & size on TTY RX+++*/
#endif
