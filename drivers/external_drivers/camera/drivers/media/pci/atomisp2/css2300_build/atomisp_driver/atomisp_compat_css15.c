...
extern bool g_ISP_output_first_frame; /* ASUS_BSP bill_chen "add ISP input and output first frame debug" */
...
/* ASUS_BSP +++ bill_chen "add ISP input and output first frame debug" */
			if (true == g_ISP_output_first_frame) {
				pr_info("%s CSS_EVENT_OUTPUT_FRAME_DONE -\n", __func__);
				g_ISP_output_first_frame = false;
			}
/* ASUS_BSP --- bill_chen "add ISP input and output first frame debug" */
			break;
		case CSS_EVENT_3A_STATISTICS_DONE:
