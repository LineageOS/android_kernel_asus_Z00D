...
stopsensor:
	...
	if (0 == strncmp(isp->inputs[asd->input_curr].camera->name, "t4k1481", strlen("t4k1481"))) {
	...
	struct v4l2_ext_controls *c)
{
	...
	for (i = 0; i < c->count; i++) {
		...
		case V4L2_CID_3A_LOCK:
		case V4L2_CID_HILIGHT_MODE:/*ASUS_BSP PJ "add lowlight mode control binning weight interface"*/
		case V4L2_CID_SET_DPC:/*ASUS_BSP PJ "add control DPC interface"*/
		case V4L2_CID_SET_DRAKMODE:/*ASUS_BSP ZZ "Implement dark mode"*/
			/*
