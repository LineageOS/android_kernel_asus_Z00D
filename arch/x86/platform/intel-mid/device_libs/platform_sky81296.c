...
void *sky81296_platform_data_func(void *info)
{
	...
	platform_sky81296_data.i2c_control_enable= 54;
	platform_sky81296_data.flash_enable= 53;
	...
	platform_sky81296_data.shutoff_on_inhibit_mode = false;
	platform_sky81296_data.enable_voltage_monitor = false;
	platform_sky81296_data.input_voltage_threshold = 2800;
	platform_sky81296_data.input_voltage_hysteresis = 2900;
	printk("[CCY] sky81296_platform_data_func\n");
