...
#include "device_libs/platform_kxtj9.h"
/* ASUS_BSP --- Peter_Lu "Akm09911 compass sensor & KXTJ9 Gsensor*/
...
#include "device_libs/platform_ft3x17.h"
#endif
...
struct devs_id __initconst device_ids[] = {
	/* UART devices */
	{"bcm_4752", SFI_DEV_TYPE_UART, 0, &intel_mid_gps_device_init, NULL},
...
/* ASUS_BSP +++ Peter_Lu "Akm09911 compass sensor & KXTJ9 Gsensor*/
	{"ak09911", SFI_DEV_TYPE_I2C, 0, &akm09911_platform_data, NULL},
	{"kxtj2", SFI_DEV_TYPE_I2C, 0, &kxtj9_platform_data, NULL},
/* ASUS_BSP --- Peter_Lu "Akm09911 compass sensor & KXTJ9 Gsensor*/
#ifdef CONFIG_TOUCHSCREEN_HIMAX_HX8528_ME372CL
	{"hx8528", SFI_DEV_TYPE_I2C, 0, &hx8528_platform_data},
#endif
#ifdef CONFIG_TOUCHSCREEN_FT3X17
	{"ft3x17", SFI_DEV_TYPE_I2C, 0, &ft3x17_platform_data},
#endif
	{"smb358", SFI_DEV_TYPE_I2C, 0, &smb345_platform_data, NULL},
	{"ug3105", SFI_DEV_TYPE_I2C, 0, &no_platform_data, NULL},
...
/* ASUS_BSP +++ srhuang "CM36686 IR sensor */
	{"cm36686", SFI_DEV_TYPE_I2C, 0, &no_platform_data, NULL},	
/* ASUS_BSP --- srhuang "CM36686 IR sensor */
...
/* ASUS_BSP +++ PJ&Bill "Back&Front Camera Porting"*/
	...
	{"sky81296", SFI_DEV_TYPE_I2C, 0, &sky81296_platform_data_func,
					&intel_register_i2c_camera_device},
