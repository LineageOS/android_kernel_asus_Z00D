...
struct mmc_host {
	...
	unsigned int		f_min;
	unsigned int		f_mid;			/*ASUS_BSP Deeo : Intel SD workaround patch */
	unsigned int		f_max;
	unsigned int		f_max_card;		/*ASUS_BSP Deeo : Intel SD workaround patch */
	unsigned int		f_init;
	u32			ocr_avail;
...
#define MMC_CAP2_BROKEN_MAX_CLK (1 << 24)	/*ASUS_BSP Deeo : Intel SD workaround patch */
